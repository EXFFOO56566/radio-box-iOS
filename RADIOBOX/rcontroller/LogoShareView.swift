...
class LogoShareView: UIView {
   ...
   // @IBOutlet weak var logoImageView: UIImageView!
    ...
    func shareSetup(albumArt : UIImage, radioShoutout: String, trackTitle: String, trackArtist: String) {
        ...
        self.trackTitleLabel.padding = UIEdgeInsets(top: 0, left: 16, bottom: 0, right: 0)
        self.trackArtistLabel.padding = UIEdgeInsets(top: 0, left: 16, bottom: 0, right: 0)
        self.radioShoutoutLabel.padding = UIEdgeInsets(top: 0, left: 16, bottom: 0, right: 0)
