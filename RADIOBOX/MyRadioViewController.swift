...
class MyRadioViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var allRadio = [Radio]()
    var allRadioDell = [Radio]()
    var allDellLike = [Like]()
    var user: User!
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if (editingStyle == .delete) {
            ...
            let radio = allRadio[indexPath.row]
            deleteAllRecords(radio: radio)
    ...
    func deleteAllRecords(radio:Radio){
        ...
        query?.findObjectsInBackground(block: { (object, error) in
            ...
            if (error == nil){
                ...
                self.allDellLike = object  as! [Like]
                
                for like in self.allDellLike{
                    
                    like.deleteInBackground { (ok, error) in
