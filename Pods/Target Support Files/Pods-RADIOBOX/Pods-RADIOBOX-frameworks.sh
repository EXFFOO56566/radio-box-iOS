...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/AlertViewBuilder/AlertViewBuilder.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/KBImageView/KBImageView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TOSegmentedControl/TOSegmentedControl.framework"
